...
export default function CaseStudyMetrics({ title, metrics }: CaseStudyMetricsProps) {
  // Determine if we're using before/after metrics or single value metrics
  const isBeforeAfterMetric = (metric: Metric) => {
    return metric.before !== undefined && metric.after !== undefined
  }
